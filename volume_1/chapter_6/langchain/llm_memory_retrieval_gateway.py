"""Chapter 6 retrieval-ready gateway built on chapter 5 structured memory."""
...
from llm_memory_structured_gateway import LangChainLLMManager as Chapter5StructuredManager
