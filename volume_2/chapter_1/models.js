...
export function getIdentifierMappings() {
  return {
    ...
    google_gemini_3_1_pro: { name: "google_gemini_3_1_pro", provider: "google", model: "gemini-3.1-pro-preview" },
    google_gemini_3_1_flash: { name: "google_gemini_3_1_flash", provider: "google", model: "gemini-3.1-flash-preview" },
    google_gemini_3_1_flash_lite: { name: "google_gemini_3_1_flash_lite", provider: "google", model: "gemini-3.1-flash-lite-preview" },
